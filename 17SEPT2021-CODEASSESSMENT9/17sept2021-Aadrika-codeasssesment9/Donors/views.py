...
from BloodAdmin.serializers import DonorSerializer,BloodAdminSerializer
    ...
    try:
        ...
        if(pserialize.data):
            for i in pserialize.data:
                ...
                getbloodgroup=i['bloodg']
                


            request.session['uid']=getid
            request.session['uname']=getpname
            data={"name":getpname,"paddress":getpaddress,"bloodg":getbloodgroup}
